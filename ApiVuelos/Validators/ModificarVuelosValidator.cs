...
{
    public class ModificarVuelosValidator : AbstractValidator<ModificarVueloDto>
    {
        public ModificarVuelosValidator()
        {
            RuleFor(x => x.IdVuelo).NotEmpty().WithMessage("Error, Debe ingresar el ID del vuelo");
